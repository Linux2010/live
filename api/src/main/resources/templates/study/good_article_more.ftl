...
<head>
    ...
    <script src="${ctx}js/study/good_article.js"></script>
...
<div class="con1">
    <span style="width: 20%;display: inline-block;"><a href="${ctx}wap/study/study_today?userId=${userId!}" style="color: white"><</a></span><span style="width: 60%;display: inline-block;margin: 0 auto;text-align: center;">好文推荐</span>
</div>
...
<div id="wrapper" style="z-index: 1;top:1rem;">
    <div class="scroller">
        ...
        <div id="goodArticleDiv" class='con3'></div>
