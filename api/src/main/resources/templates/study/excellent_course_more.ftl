...
<head>
    ...
    <script src="${ctx}js/study/excellent_course_more.js"></script>
...
<div class="con1">
    <span style="width: 20%;display: inline-block;"><a href="${ctx}wap/study/today_recomm" style="color: white"><</a></span><span style="width: 60%;display: inline-block;margin: 0 auto;text-align: center;">优质课程</span>
</div>
