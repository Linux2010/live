...
<div class="con1">
    <span style="width: 20%;display: inline-block;"><a href="${ctx}wap/wx/login"><</a></span><span
        style="width: 60%;display: inline-block;margin: 0 auto;text-align: center;">找回密码</span>
</div>
<#--<div class="con2">
...
<div class="con3">
    ...
    <form style="display: none;" id="findpwd_from" action="${ctx}wap/user/findPwdToSecond" method="post">
