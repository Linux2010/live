...
<div class="con1">
    <span style="width: 20%;display: inline-block;"><a href="${ctx}wap/user/findPwd"><</a></span><span
        style="width: 60%;display: inline-block;margin: 0 auto;text-align: center;">重置密码</span>
</div>
<div class="con3">
    <div class="con3Con">
        <input class="newpwd" type="password" placeholder="请输入一个6-12位的新密码"/>
    </div>
    <div class="con3Con">
        <input class="requirepwd" type="password" placeholder="请再次输入"/>
    </div>
    <div class="con3Con">
