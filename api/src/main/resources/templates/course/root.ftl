...
<input type="hidden" id="accId" value="${user.accid!}"/>
<input type="hidden" id="accidToken" value="${user.accidToken!}"/>
<input type="hidden" id="userName" value="${user.userName!}"/>
<input type="hidden" id="teaAccid" value="${teaUser.accid!}"/>
<input type="hidden" id="jtxyappUrl" value="${jtxyappUrl!}"/>
<video id="my-video" class="video video-js" x-webkit-airplay="allow"
       webkit-playsinline controls poster="//nos.netease.com/vod163/poster.png"
       data-setup="{}" >
</video>
<div class="tab">
    <div class="tabNav">
...
<div class="tabBody">
    <div class="anchorLine">
        <img class="anchorImg" src="${teaUser.photo!}"/>
        <span id="chatroom-verified">已证实</span>
        <span id="nickName">${teaUser.nickName!}</span>
        <div class="anchorDetail">
            <div class="anchorDetail1"> <span>主播：</span><span>${teaUser.userName!}</span></div>
...
<script src="${ctx}im/chatroom/dist/js/util.js"></script>
...
<script src="${ctx}im/chatroom/dist/js/room.js"></script>
