...
<head>
    ...
    <script src="${ctx}js/jquery.min.js?v=1" type="text/javascript" ></script>
...
<div id="body_s" style="display: none;">
    ...
    <div class="con1">
        <div class="con1Select">
            ...
            <span style="width: 90%;display: inline-block;margin: 0 auto;text-align: center;padding-right: 0.64rem;">视频课程详情</span>
        </div>
    </div>
    <div id="wrapper" style="z-index: 1;top:1rem;width: 100%;height: 100%;overflow: hidden;">
        <div class="scroller">
            ...
            <div>
                ...
                <div class="radio" id="courseImg" style="display: none;"></div>
                <video id="my-video" class="video-js radio vjs-big-play-centered vjs-fluid"  x-webkit-airplay="allow" webkit-playsinline controls preload="auto" data-setup='{}'></video>
                <div class="con4">
                    <div class="con4Title">
                    ...
                    <div class="con4Body">
                        ...
                        <div class="line1"><img src="${ctx}image/RMB.png"><span id="cpSpan"></span><a href="javascript:;"><span class="payVip" onclick="showJsPage()" style="display: none;">立即购买</span></a></div>
                        <div class="line1"><img src="${ctx}image/level.png"><span id="vpSpan"></span>(会员可免费观看)</div>
                    </div>
                </div>
                <div class="con4">
                    <div class="con4Title">
...
<script src="${ctx}js/course/spkcDetail.js?v=13" type="text/javascript"></script>
</body>
</html>