...
<head>
    ...
    <script src="${ctx}js/course/ypkcIndex.js?v=3" type="text/javascript"></script>
    <style type="text/css">
...
<div class="con1">
    <div class="con1Select">
        ...
        <span style="width: 90%;display: inline-block;margin: 0 auto;text-align: center;padding-right: 0.64rem;">音频课程</span>
    </div>
</div>
