...
<div id="body_s" style="display: none;">
    ...
    <input type="hidden" id="imRoomid"/>
    <input type="hidden" id="courseBeginTime"/>
    <div class="con1">
        <div class="con1Select">
            <span style="width: 10%;display: inline-block;" onclick="backFuc()"><</span>
            <span style="width: 90%;display: inline-block;margin: 0 auto;text-align: center;padding-right: 0.64rem;">直播课程详情</span>
        </div>
    </div>
    <div id="wrapper" style="z-index: 1;top:1rem;width: 100%;height: 100%;overflow: hidden;">
        <div class="scroller">
            ...
            <div>
                ...
                <div style="position: relative;height: 3rem;" onclick="showRoom()">
                    <div style="width:100%;height: 100%;position: absolute">
                        <img src="${ctx}image/zbimg.png" style="width:1.5rem;display: block;margin:0.75rem auto"/>
                    </div>
...
<script src="${ctx}js/course/zbkcDetail.js?v=15" type="text/javascript"></script>
</body>
</html>