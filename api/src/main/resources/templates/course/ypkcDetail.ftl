...
<div id="body_s" style="display: none;">
    ...
    <div class="con1">
        <div class="con1Select">
            ...
            <span style="width: 90%;display: inline-block;margin: 0 auto;text-align: center;padding-right: 0.64rem;">音频课程详情</span>
        </div>
    </div>
    <div id="wrapper" style="z-index: 1;top:1rem;width: 100%;height: 100%;overflow: hidden;">
        <div class="scroller">
            ...
            <div>
                ...
                <audio id="my-audio" style="width: 100%;" controls="controls"></audio>
                <div class="con4">
                    <div class="con4Title">
...
<script src="${ctx}js/course/ypkcDetail.js?v=13" type="text/javascript"></script>
</body>
</html>