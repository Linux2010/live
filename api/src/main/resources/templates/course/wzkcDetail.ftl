...
<div id="body_s" style="display: none;">
    ...
    <input type="hidden" id="courseBeginTime"/>
    <div class="con1">
        <div class="con1Select">
            <span style="width: 10%;display: inline-block;" onclick="backFuc()"><</span>
            <span style="width: 90%;display: inline-block;margin: 0 auto;text-align: center;padding-right: 0.64rem;">文字课程详情</span>
        </div>
    </div>
            ...
            <div>
                ...
                <div class="con4">
                    <div class="con4Title">
                        ...
                        <span onclick="showWzkcContent()"
                              style="padding:0.1rem 0.2rem;border-radius: 0.15rem;background-color: #ffa42f;
                                        color:white;float: right;font-size: 0.26rem;margin:0.1rem 0.2rem;
                                        font-weight:100;line-height: 0.24rem;" id="wzSpan">文章</span>
                    </div>
...
<script src="${ctx}js/course/wzkcDetail.js?v=13" type="text/javascript"></script>
</body>
</html>