$(function(){
    ...
    $("#searchSpan").click(function(){
        ...
        showWzkcList(1,10,$("#courseTitle").val(),1);
    });
    ...
    function pullUpAction(){
        setTimeout(function(){
            curpage++;
            showWzkcList(curpage,10,$("#courseTitle").val(),0);
        }, 1000)
    }
    ...
    // 展示文字课程列表
    function showWzkcList(pageNum,pageSize,courseTitle,allIscrollState){
        $.ajax({
            async: true,
            type: "POST",
            url: $("#basePath").val() + "wap/course/showWzkcList",
...
function showCourseDetail(couserId){
    location.href = $("#basePath").val()+"wap/course/courseDetail?courseType=wzkc&courseId="+couserId;
}
