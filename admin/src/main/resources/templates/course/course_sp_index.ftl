    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height:600px; overflow:scroll; ">
                <form id="upload-form-courseSp" enctype="multipart/form-data" class="form-horizontal">
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="uploadCourseSp">上 传</button>
...
<script src="${ctx}/js/course/courseSpIndex.js"></script>
