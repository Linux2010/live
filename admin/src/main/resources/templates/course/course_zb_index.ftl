...
<div class="col-xs-12" style="margin-top: 10px;">
    <form class="form-horizontal">
        <div class="form-group">
            <div class="col-sm-3">
                <select id="zbType" class="col-xs-12" style="height: 34px;">
                    <option value="">--请选择--</option>
                    <option value="sp">视频直播</option>
                    <option value="yp">音频直播</option>
                </select>
            </div>
            <div class="col-sm-3">
...
<script src="${ctx}/js/course/courseZbIndex.js"></script>
