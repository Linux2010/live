...
<div class="modal-body">
    <form id="update-form-course" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                ...
                <a id="course_cover_link" href="#" target="_blank">原课程封面查看</a>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                ...
                <a id="course_img_link" href="#" target="_blank">原课程列表图片查看</a>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="recordName"><small class="red">*</small>积分数:</label>
            <div class="col-xs-6">
                <input type="text" id="courseIntegral" name="courseIntegral" class="form-control"/>
            </div>
        </div>
...
<div class="modal-footer" style="text-align:center;">
    <button type="button" class="btn btn-primary" id="updateCourse">修 改</button>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="${ctx}/js/course/courseSpEdit.js"></script>
