...
<div class="modal-body">
    <form id="update-form-course" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="recordName"><small class="red">*</small>直播类型:</label>
            <div class="col-xs-6">
                <select id="zbType" name="zbType" class="form-control">
...
<script src="${ctx}/js/course/courseZbEdit.js"></script>
