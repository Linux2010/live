...
<div class="modal-body" style="height: 380px">
    <form id="add-form-advertise" class="form-horizontal" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input type="text" id="adver_name_add" name="adverName" class="form-control"/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label no-padding-right" for="recordName"><small class="red">*</small>广告图片：</label>
            <div class="col-xs-6">
                <input type="file" id="adver_img_add" name="file" class="form-control"/>
            </div>
        </div>
        <div class="form-group">
            <label style="margin-top: -9px" class="col-sm-2 control-label no-padding-right" for="recordName"><small class="red">*</small>是否显示：</label>
            <div class="col-sm-6">
                <input type="radio" name="status_add" class="col-xs-12 col-sm-1" value="1"/><div style="float: left">显示</div>
                <input type="radio" name="status_add" class="col-xs-12 col-sm-1" value="2"/><div style="float: left">不显示</div>
            </div>
        </div>
        <div class="form-group">
        ...
        <input type="hidden" id="detail_id" name = "detailId">
        <input type="hidden" id="name" name = "name">
    </form>
</div>
<div class="modal-footer" style="text-align:center;">
    <button type="button" class="btn btn-primary" id="add_advertise">添 加</button>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="${ctx}/js/advertise/addAdvertise.js"></script>
