...
<div class="col-xs-12">
    ...
    <form id="add-form-coupon" class="form-horizontal">
        ...
        <div class="form-group">
             ...
             <div class="col-sm-9">
                  <input type="text" id="couponName" name="couponName"  placeholder="优惠劵名称" class="col-xs-12 col-sm-5" value="${coupon.couponName!}" onblur="javascript:couponNameOnBlus(this)"/>
             </div>
          </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                 <input type="text" id="couponDesc" name="couponDesc"  placeholder="优惠劵描述" class="col-xs-12 col-sm-5" value="${coupon.couponDesc!}" />
            </div>
        </div>
        <div class="hr hr-18 dotted"></div>
        <div class="form-group">
            ...
            <div class="col-xs-9">
                <input name="couponType" type="radio" class="ace" value="0"
                       <#if coupon.couponType == 0>checked = "true"</#if>
                       >
                <span class="lbl">商品</span>
            <#--<input name="couponType" type="radio" class="ace" value="1"    <#if coupon.couponType == 1>checked = "true"</#if> >-->
            <#--<span class="lbl">课程</span>-->
                <input name="couponType" type="radio" class="ace"  value="2"   <#if coupon.couponType == 2>checked = "true"</#if>  >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="couponValue" name="couponValue"  placeholder="面值金额" class="col-xs-12 col-sm-5" value="${coupon.couponValue!?c}" />
            </div>
        </div>
        <div class="hr hr-18 dotted"></div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="limitMoney" name="limitMoney"  placeholder="限制金额" class="col-xs-12 col-sm-5" value="${coupon.limitMoney!?c}" onblur="limitMoneyOnBlus(this)" />
            </div>
        </div>
        <div class="hr hr-18 dotted"></div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="limitMoneyDesc" name="limitMoneyDesc"  placeholder="使用条件" class="col-xs-12 col-sm-5" value="${coupon.limitMoneyDesc!}"/>
            </div>
        </div>
        <div class="hr hr-18 dotted"></div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="couponBeginTimeStr" name="couponBeginTimeStr" class="form-control date-picker"   value="${couponBeginTimeStr!}"  style="width: 41.9%;"/>
            </div>
        </div>
        <div class="hr hr-18 dotted"></div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="couponEndTimeStr" name="couponEndTimeStr" class="col-xs-12 col-sm-5 form-control date-picker" value="${couponEndTimeStr!}" style="width: 41.9%;"/>
            </div>
        </div>
     ...
     <#--   <div class="hr hr-18 dotted"></div>
        <div class="form-group">
            ...
            <div class="col-sm-4">
                  <input type="file" id="imageUrl" name="file" class="col-xs-12 col-sm-5 form-control"  height="34" value="${coupon.couponImgUrl!}" />
            </div>
            <div class="col-sm-4" style="margin-top: 4px;">
                <#if coupon.couponImgUrl ??>
                    <a href="${coupon.couponImgUrl!}" target="_blank" ><img src="${coupon.couponImgUrl!}" id="img3" width="100" height="34"/></a>
                </#if>
            </div>
        </div>-->
        <div class="hr hr-18 dotted"></div>
...
<script src="${ctx}/js/goods/coupon_edit_index.js"></script>
