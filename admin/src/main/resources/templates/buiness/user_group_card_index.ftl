<#assign title="团购卡管理"/>
<#assign menuId="0b0558535ffb4441a61386cf8dec8454"/>
...
<div class="col-xs-12">
    <input type="hidden" id="userId" value="${(Session.SPRING_SECURITY_CONTEXT.authentication.principal.userId)!}"/>
</div>
...
<script src="${ctx}/js/user/user_group_card_index.js?v=2"></script>
