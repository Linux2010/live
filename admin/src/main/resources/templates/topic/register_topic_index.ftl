    ...
    <form class="form-search" id="form-search" method="post">
        <div class="form-group">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" placeholder="查找 考题名称" class="nav-search-input input-xxlarge"  style="width:30%;"  id="nav-search-input" autocomplete="off" name="keyword"/>
                </div>
                <div class="col-sm-1">
                ...
                <form id="add-form-topic" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" style="padding: 8px 19px 3px 14px;">
                            <input name="isRegisterTopic" type="radio" class="ace" value="0" checked = "true" >
                            <span class="lbl">注册考题</span>
                            <input name="isRegisterTopic" type="radio" class="ace" value="1"  disabled="disabled">
...
<script src="${ctx}/js/course/register_topic_index.js"></script>
