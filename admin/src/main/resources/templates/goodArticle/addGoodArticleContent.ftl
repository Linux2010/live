...
<input type="hidden" id="goodArticleId" value="${goodArticleId}"/>

<div class="modal-header">
    <h4 class="modal-title"><span id="title"></span></h4>
</div>
<div class="modal-body" id="ctDetail">
    <div id="container" name="content" type="text/plain" style="height:300px;"></div>
</div>
...
<script src="${ctx}/js/goodArticle/addGoodArticleContent.js"></script>
