...
<div class="modal-content">
    ...
    <div class="modal-body" style="max-height:600px; overflow:scroll; ">
        <form id="form-data" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label no-padding-right" for="loginName">三级分润用户名</label>
                <div class="col-sm-9">
        ...
        $.ajax({
            ...
            success: function (data) {
                if ("success" == data.status){
                    ...
                    location.href = base + 'profitshare/relation/pageskip?relationId='+"${profitShareRelation.relationId}"+'&level=3';
                }else{
