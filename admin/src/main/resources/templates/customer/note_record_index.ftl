<#assign title="短信管理"/>
<#assign menuId="0879e23f73cd4e0b9090fae8f4483481"/>
            ...
            <div class="modal-body" style="max-height:600px; overflow:scroll;">
                <form id="sendMessage-form" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="recordName"><small class="red">*</small>编辑短信内容:</label>
                        <div class="col-sm-9">
...
<script src="${ctx}/js/customer/note_record_index.js"></script>
