$(function(){
    ...
    $("#uploadBtn").click(function(){
        ...
        if(!check($("#articleId").val(),ue.getContent())){
            return false;
        }else{
            // 设置上传按钮不可用
            ...
            $.ajax({
                type:"post",
                data:{articleId:$("#articleId").val(),content:ue.getContent(),showContent:showContent},
                dataType:"json",
                url:base+"article/addContent",
                success: function(data) {
                    // 设置上传按钮可用
                    ...
                    if("success" == data.status){
                        ...
                        setTimeout(function () {
                            window.location.href=base+"article/";
                        },1800)
                    }else{
