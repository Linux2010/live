jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {name: 'recSort', index: 'recSort', width: 500, editable: true, editoptions: {size: "20", maxlength: "30"}, editrules:{number:true}},
            {
...
function add() {
    window.location.href = base + "recsetting/all_rec";
}
function edit(id) {
...
$("#updatesort").on("click",function () {
    ...
    $.ajax({
        ...
        data: {'recSetId':  $("#recSetId_update").val(),"recSort":$("#recSort_update").val(),"num":2},
        dataType: "json",
        success: function (data) {
            if (data.status == "success") {
                Modal.alert({
