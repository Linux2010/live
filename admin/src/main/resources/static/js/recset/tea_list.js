        ...
        colModel: [
            ...
            {name: 'recSort', index: 'recSort', width: 400, editable: true, editoptions: {size: "20", maxlength: "30"}, editrules:{number:true}},
            {
                ...
                formatter: function (cellvalue, options, rowObject) {
                    return "<i class='ace-icon fa fa-trash-o bigger-200' onclick='deltea(\"" + cellvalue + "\")'></i>";
                }
            }
        ],
        jsonReader: {
...
function add() {
    window.location.href = base + "recsetting/all_tea";
}
function edit(id) {
...
$("#updatesort").on("click",function () {
    ...
    $.ajax({
        ...
        data: {'recSetId':  $("#recSetId_update").val(),"recSort":$("#recSort_update").val(),"num":1},
        dataType: "json",
        success: function (data) {
            if (data.status == "success") {
                Modal.alert({
