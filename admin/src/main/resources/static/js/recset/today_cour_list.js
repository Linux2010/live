jQuery(function ($) {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        url: base + "recsetting/hasRecByTag",
        subGrid: false,
        subGridOptions: {
        ...
        colModel: [
            ...
            {
                name: 'recSetId', index: 'recSetId', width: 300, fixed: true, sortable: false, resize: false,
    ...
    $("#keyword").on("change", function () {
        ...
        history.pushState({},"今日课程推荐",showUrlVal);
...
function add() {
    window.location.href = base + "recsetting/todayCourRec/list?pass_keyword="+encodeURIComponent($("#keyword").val());
}
function edit(id) {
...
$("#updatesort").on("click",function () {
    ...
    $.ajax({
        ...
        data: {'recSetId':  $("#recSetId_update").val(),"recSort":$("#recSort_update").val(),"num":6},
        dataType: "json",
        success: function (data) {
            if (data.status == "success") {
                Modal.alert({
