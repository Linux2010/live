$(function(){
    ...
    $("#addCourse").click(function(){
        ...
        if(!verifyValue($("#course_type_id").val(),$("#courseTagId").val(),$("#courseCover").val(),$("#courseTitle").val(),
                ...
                $("#courseIntro").val(),$("#courseAddress").val(),$("#courseAddressDetail").val(),$("#courseImg").val())){
            return false;
        }else{
            // 设置发布按钮不可用
    ...
    function verifyValue(courseTypeId,courseTagId,courseCover,courseTitle,
                         ...
                         costPrice,vipPrice,seqno,courseIntro,courseAddress,courseAddressDetail,courseImg){
        var result = false;
