$(function(){
    ...
    // 校验对应数据
    function verifyValue(courseTypeId,courseTagId,
                         courseTitle,courseBeginTime,teacherId,
                         costPrice,vipPrice,seqno,courseIntro,zbType){
        var result = false;
