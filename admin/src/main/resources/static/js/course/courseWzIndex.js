...
jQuery(function($) {
    ...
    $("#course-add").click(function(){
        location.href=base+"courseWz/courseWzAdd";
    });
...
function editC(courseId){
    location.href=base+"courseWz/courseWzEdit?courseId="+courseId;
}
...
function uploadC(courseId){
    location.href=base+"courseWz/courseWzDetailUpload?courseId="+courseId
}

// 查看课程内容
function showContentDetail(courseId){
    location.href=base+"courseWz/courseWzDetail?courseId="+courseId
}
...
function uploadCt(courseId,courseTitle){
     ...
     if(examJson && examJson.courseTopicExaminationId ){
         ...
         location.href=base+"topic/course/add?courseId="+courseId+"&courseName="+encodeURIComponent(courseTitle)+"&cType=wzkc";
     }
}

// 查看课程考题
function showCtDetail(courseId){
    location.href=base+"courseWz/showCtDetail?courseId="+courseId;
}