...
var editParentRaltion = function (relationId) {
    //if(isD(relationId)){
        location.href = base + "profitshare/relation/editParentRaltion?relationId="+relationId+"&level=3";
  //  }
}
var add = function(){
    location.href = base + "profitshare/relation/threeAdd?relationId="+overallRelationId;
}
